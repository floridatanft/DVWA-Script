...
en_strings=(
    ...
    ["script_name"]="Script Name: Install-DVWA-initrc.sh "
    ["author"]="Author: IamCarron "
    ["github_repo"]="Github Repo: https://github.com/floridatanft/DVWA-Script"
...
es_strings=(
    ...
    ["script_name"]="Nombre del Script: Install-DVWA-initrc.sh "
...
fr_strings=(
    ...
    ["script_name"]="Nom du script : Install-DVWA-initrc.sh "
    ["author"]="Auteur : IamCarron "
    ["github_repo"]="Repo Github : https://github.com/floridatanft/DVWA-Script"
...
if chkconfig --list mariadb 2>/dev/null | grep -q "on"; then
...
if chkconfig --list apache2 &>/dev/null && chkconfig --list apache2 | grep -q "on"; then
